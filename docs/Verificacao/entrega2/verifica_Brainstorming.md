...
A metodologia escolhida foi a dos checklists, usando o checklist já montado para [Brainstorming](docs/Verificacao/entrega2/planejamento_entr_2.m) no planejamento dessa etapa, será avaliado o artefato. As respostas possíveis definidas para o checklist são:
...
**Tabela 2** - Checklist para o Brainstorming.

| ID  | Descrição                                                                                                 | Avaliação | Observações |
| --- | --------------------------------------------------------------------------------------------------------- | --------- | ----------- |
| 5|          A participação do cliente e/ou persona na elicitação ?                                         |    sim       |          |            |
| 6 |          As ideias estão documentadas de forma lógica e clara ?                                        |     sim      |          |            |
| 7|          Colaboração de todos integrantes para o levantamento de ideias ?                                         |   sim        |          |            |
| 8 |          Aborda todas as partes do aplicativo ?                                         |      sim     |          |            |
| 9 |          O brainstorming incluiu uma diversidade de perspectivas ?                                         |      sim     |          |            |
| 10 |          A participação do cliente e/ou persona na elicitação ?                                         |    sim       |          |            |
| 11 |          Requisitos estão diferenciados entre funcionais e não funcionais ?                                         |     sim      |          |            |
| 12 |          Identificação dos requisitos ?                                         |     sim      |          |            |
